...
private:
    ...
    std::unique_ptr<audio::Synthesizer> m_synth;
    std::unique_ptr<audio::DrumSample> m_drums;
    std::unique_ptr<audio::Scheduler> m_scheduler;
    std::unique_ptr<audio::AudioEngine> m_audioEngine;
    std::unique_ptr<audio::WavExporter> m_exporter;
