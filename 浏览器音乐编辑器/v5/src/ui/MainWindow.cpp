...
void MainWindow::setupUI() {
    ...
    m_pianoRoll = new PianoRollWidget(m_project.get(), m_editorStack);
    ...
    m_instrumentEditor = new InstrumentEditor(rightPanel);
...
void MainWindow::onExportAudio() {
    QMessageBox::information(this, "功能不可用", "音频导出功能暂不可用。");
}
